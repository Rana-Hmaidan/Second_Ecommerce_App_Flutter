                ...
                PositionedDirectional(
                  ...
                  child: DecoratedBox(
                    ...
                    child: IconButton(
                      ...
                      color: AppColors.red,
                      onPressed: () async => await cartCubit.removeFromCart(cartOrderItemOriginal),
                    ),
                  ),
                ),
                PositionedDirectional(
                  ...
                  child: BlocBuilder<CartCubit, CartState>(
                    ...
                    buildWhen: (previous, current) =>
                      (current is QuantityCounterLoading &&current.cartOrderId == cartOrderItemOriginal.id) ||
                      (current is QuantityCounterLoaded &&current.cartOrder.id == cartOrderItemOriginal.id),
                    builder: (context, state) {
                      if (state is QuantityCounterLoaded) {
                        ...
                        return CounterWidget(
                            ...
                            counter: state.cartItems.firstWhere((item) => item.id == cartOrderItemOriginal.id,).quantity
                        );
